...
const tweetList = [
    {
        iconName: 'icofont-twitter',
        desc: <span>Aminur islam <a href="#">@ShopCart Greetings!  #HTML_Template</a> Grab your item, 50% Big Sale Offer !!</span>,
    },
    {
        iconName: 'icofont-twitter',
        desc: <span>Somrat islam <a href="#">@ShopCart Hey! #HTML_Template</a> Grab your item, 50% Big Sale Offer !!</span>,
    },
]
        ...
        <div className="footer-buttom">
            <div className="container">
                <div className="section-wrapper">
                    <p>&copy; 2024 <Link to="/">Shop Cart</Link> Designed by <a href="/" target='_blank'>Syed Nathim</a></p>
